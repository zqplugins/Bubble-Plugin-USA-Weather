async function(properties, context) {
	...
	async function server(_0x45c339, _0x22e4f4) {
		...
		let _0x3433c0 = require('nws-api-wrapper'),
			_0x53a53f = _0x45c339[_0x2057f9(0x125)],
			_0x2c3411 = _0x45c339[_0x2057f9(0x116)];
		if (!_0x53a53f || !_0x2c3411)
			return;
		return _0x22e4f4['v3'][_0x2057f9(0x117)](async _0x3fa632 => {
			const _0xf756ed = _0x2057f9;
			try {
				let _0x557953 = await _0x3433c0[_0xf756ed(0x123)](_0x53a53f, _0x2c3411, 0x1),
					_0xb795e4 = _0x557953[0x0];
				if (!_0xb795e4)
					throw Error('Couldn\x27t\x20get\x20weather');
				let _0x221390 = /\b\d+(?:%|percent\b)/,
					_0x40b163 = _0xb795e4[_0xf756ed(0x124)],
					_0x3e4d62 = _0x40b163[_0xf756ed(0x115)](_0x221390),
					_0x2f2971 = 0x0;
				if (_0x3e4d62) {
					let _0x3d3331 = _0x3e4d62[0x0],
						_0x12eb98 = _0x3d3331['slice'](0x0, -0x1);
